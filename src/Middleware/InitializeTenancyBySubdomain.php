...
class InitializeTenancyBySubdomain extends InitializeTenancyByDomain implements MiddlewareInterface
{
    /**
    ...
    {
        $subdomain = $this->makeSubdomain($request->getUri()->getHost());
        ...
        if (is_object($subdomain) && $subdomain instanceof Exception) {
            ...
            return $onFail($subdomain, $request, $handler);
        }
